...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gradientThresholdCheckBox.setGeometry(QtCore.QRect(10, 89, 188, 23))
        ...
        self.gradientThresholdLineEdit.setGeometry(QtCore.QRect(222, 88, 50, 29))
        ...
        self.unsharpGaussianLowCheckBox = QtWidgets.QCheckBox(self.settingsContainer)
        self.unsharpGaussianLowCheckBox.setGeometry(QtCore.QRect(33, 277, 120, 23))
        self.unsharpGaussianLowCheckBox.setObjectName("unsharpGaussianLowCheckBox")
        self.unsharpGaussianLowLineEdit = QtWidgets.QLineEdit(self.settingsContainer)
        self.unsharpGaussianLowLineEdit.setGeometry(QtCore.QRect(222, 269, 50, 28))
        ...
        self.unsharpGaussianHighCheckBox = QtWidgets.QCheckBox(self.settingsContainer)
        self.unsharpGaussianHighCheckBox.setGeometry(QtCore.QRect(32, 302, 124, 23))
        self.unsharpGaussianHighCheckBox.setObjectName("unsharpGaussianHighCheckBox")
        self.unsharpGaussianHighLineEdit = QtWidgets.QLineEdit(self.settingsContainer)
        self.unsharpGaussianHighLineEdit.setGeometry(QtCore.QRect(222, 300, 50, 29))
        ...
        self.unsharpHFScaleCheckBox = QtWidgets.QCheckBox(self.settingsContainer)
        self.unsharpHFScaleCheckBox.setGeometry(QtCore.QRect(32, 330, 97, 23))
        self.unsharpHFScaleCheckBox.setObjectName("unsharpHFScaleCheckBox")
        self.unsharpHFScaleLineEdit = QtWidgets.QLineEdit(self.settingsContainer)
        self.unsharpHFScaleLineEdit.setGeometry(QtCore.QRect(222, 332, 50, 27))
        ...
        self.processButton.setGeometry(QtCore.QRect(86, 728, 75, 27))
        ...
        self.attenuationDecayLineEdit.setGeometry(QtCore.QRect(222, 198, 50, 29))
        ...
        self.attenuationFactorLineEdit.setGeometry(QtCore.QRect(222, 166, 50, 28))
        ...
        self.labelAttenuationFactor.setGeometry(QtCore.QRect(13, 170, 151, 20))
        self.labelAttenuationFactor.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.labelAttenuationDecay.setGeometry(QtCore.QRect(22, 198, 171, 20))
        ...
        self.p1CheckBox.setGeometry(QtCore.QRect(16, 408, 165, 20))
        font = QtGui.QFont()
        ...
        self.p2CheckBox.setGeometry(QtCore.QRect(16, 436, 204, 19))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.labelExperimental.setGeometry(QtCore.QRect(18, 380, 157, 18))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.p1LineEdit.setGeometry(QtCore.QRect(222, 401, 50, 27))
        ...
        self.p2LineEdit.setGeometry(QtCore.QRect(222, 431, 50, 27))
        ...
        self.p3LineEdit.setGeometry(QtCore.QRect(222, 460, 50, 27))
        ...
        self.p3CheckBox.setGeometry(QtCore.QRect(16, 465, 190, 19))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.p4LineEdit.setGeometry(QtCore.QRect(222, 490, 50, 27))
        ...
        self.p4CheckBox.setGeometry(QtCore.QRect(16, 495, 191, 19))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.p6LineEdit.setGeometry(QtCore.QRect(222, 551, 50, 27))
        ...
        self.p5CheckBox.setGeometry(QtCore.QRect(16, 525, 190, 22))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.p7LineEdit.setGeometry(QtCore.QRect(222, 582, 50, 27))
        ...
        self.p6CheckBox.setGeometry(QtCore.QRect(16, 555, 158, 19))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.p8LineEdit.setGeometry(QtCore.QRect(222, 613, 50, 27))
        ...
        self.p7CheckBox.setGeometry(QtCore.QRect(16, 585, 187, 24))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.p8CheckBox.setGeometry(QtCore.QRect(16, 615, 194, 19))
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.p5LineEdit.setGeometry(QtCore.QRect(222, 521, 50, 27))
        ...
        self.labelFileOutput.setGeometry(QtCore.QRect(16, 660, 168, 25))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.fileOBJCheckBox.setGeometry(QtCore.QRect(15, 690, 165, 20))
        self.fileOBJCheckBox.setObjectName("fileOBJCheckBox")
        self.labelSigma = QtWidgets.QLabel(self.settingsContainer)
        self.labelSigma.setGeometry(QtCore.QRect(184, 432, 35, 23))
        font = QtGui.QFont()
        font.setFamily("Symbol")
        font.setPointSize(19)
        self.labelSigma.setFont(font)
        ...
        MainWindow.setTabOrder(self.unsharpMaskingCheckBox, self.unsharpGaussianLowCheckBox)
        MainWindow.setTabOrder(self.unsharpGaussianLowCheckBox, self.unsharpGaussianLowLineEdit)
        MainWindow.setTabOrder(self.unsharpGaussianLowLineEdit, self.unsharpGaussianHighCheckBox)
        MainWindow.setTabOrder(self.unsharpGaussianHighCheckBox, self.unsharpGaussianHighLineEdit)
        MainWindow.setTabOrder(self.unsharpGaussianHighLineEdit, self.unsharpHFScaleCheckBox)
        MainWindow.setTabOrder(self.unsharpHFScaleCheckBox, self.unsharpHFScaleLineEdit)
        MainWindow.setTabOrder(self.unsharpHFScaleLineEdit, self.p1CheckBox)
        ...
        MainWindow.setTabOrder(self.p8LineEdit, self.processButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.unsharpGaussianLowCheckBox.setText(_translate("MainWindow", "Gaussian &Low"))
        self.unsharpGaussianHighCheckBox.setText(_translate("MainWindow", "Gaussian &High"))
        self.unsharpHFScaleCheckBox.setText(_translate("MainWindow", "&HF Scaling"))
        ...
        self.labelAttenuationFactor.setText(_translate("MainWindow", "F: a = F * mean |X|"))
        ...
        self.p1CheckBox.setText(_translate("MainWindow", "P1: Relief Scale"))
        self.p2CheckBox.setText(_translate("MainWindow", "P2 Silhouette: On/Off,"))
        self.labelExperimental.setText(_translate("MainWindow", "Experimental"))
        self.p3CheckBox.setText(_translate("MainWindow", "P3 Silhouette: Iterations"))
        self.p4CheckBox.setText(_translate("MainWindow", "P4: Gaussian Mask"))
        self.p5CheckBox.setText(_translate("MainWindow", "P5: Numpy Gradients"))
        self.p6CheckBox.setText(_translate("MainWindow", "P6: Translate +Z"))
        self.p7CheckBox.setText(_translate("MainWindow", "P7: Force Planar"))
        self.p8CheckBox.setText(_translate("MainWindow", "P8: NormalMap Gradients"))
        ...
        self.labelFileOutput.setText(_translate("MainWindow", "<html><head/><body><p>File Output</p></body></html>"))
        self.fileOBJCheckBox.setText(_translate("MainWindow", "Wavefront OBJ"))
        self.labelSigma.setText(_translate("MainWindow", "s"))
