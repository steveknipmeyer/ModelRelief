// -----------------------------------------------------------------------
// <copyright file="AutoRollbackAttribute.cs" company=".NET Foundation and Contributors">
// Copyright (c) .NET Foundation and Contributors. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------

// https://github.com/xunit/samples.xunit/blob/main/AutoRollbackExample/AutoRollbackAttribute.cs
namespace ModelRelief.Test
{
    ...
    public sealed class AutoRollbackAttribute : BeforeAfterTestAttribute
    {
        ...
        /// </summary>
        /// <param name="methodUnderTest">Active test method.</param>
