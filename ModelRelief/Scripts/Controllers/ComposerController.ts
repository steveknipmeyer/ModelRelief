...
//#region Event Handlers
    ...
    async updateDepthBufferAsync(): Promise<Dto.DepthBuffer> {
        ...
        let factory = new DepthBufferFactory({ width: this._reliefWidthPixels, height: this._reliefHeightPixels, modelGroup: this.modelViewer.modelGroup, camera: this.activeDepthBufferCamera, addCanvasToDOM: true });
