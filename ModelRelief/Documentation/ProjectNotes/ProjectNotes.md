...
#### Short Term  
    ...
    Settings
        Tau                 GradientThreshold
        SigmaGaussianBlur   UnsharpGaussianLow
        SigmaGaussianSmooth UnsharpGaussianHigh
        LambdaLinearScaling UnsharpHighFrequencyScale
                            AttenuationFactor
                            AttenuationDecay
                            P1
                            P2
    Solver
        Verify Solver runs as a command line tool.
            This is the mode that is employed by the unit tests.
