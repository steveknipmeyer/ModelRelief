...
define("Views/MeshViewer", ["require", "exports", "three", "DepthBuffer/DepthBuffer", "Views/Graphics", "Views/MeshViewerControls", "System/Services", "Views/Viewer"], function (require, exports, THREE, DepthBuffer_2, Graphics_7, MeshViewerControls_1, Services_7, Viewer_1) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
...
define("Views/ModelViewer", ["require", "exports", "three", "System/EventManager", "Views/ModelViewerControls", "Views/Viewer"], function (require, exports, THREE, EventManager_2, ModelViewerControls_1, Viewer_2) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
...
define("Controllers/ModelReliefController", ["require", "exports", "Views/Camera", "System/EventManager"], function (require, exports, Camera_5, EventManager_3) {
    ...
    var ModelReliefController = (function () {
         ...
         * @constructor
         */
        function ModelReliefController(modelReliefView) {
        ...
        ModelReliefController.prototype.initialize = function () {
            this._modelReliefView._modelViewer.eventManager.addEventListener(EventManager_3.EventType.NewModel, this.onNewModel.bind(this));
        };
        //#endregion
        //#region Event Handlers
        /**
        ...
        ModelReliefController.prototype.onNewModel = function (event, model) {
            this._modelReliefView._modelViewer.setCameraToStandardView(Camera_5.StandardView.Front);
            this._modelReliefView._meshViewer.setCameraToStandardView(Camera_5.StandardView.Top);
        };
...
define("Views/ModelReliefViewControls", ["require", "exports", "dat-gui", "DepthBuffer/DepthBufferFactory", "ModelExporters/OBJExporter", "System/Services"], function (require, exports, dat, DepthBufferFactory_2, OBJExporter_1, Services_8) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
     ...
     */
    var ModelReliefViewSettings = (function () {
        function ModelReliefViewSettings(generateRelief, saveRelief) {
            this.generateRelief = generateRelief;
            this.saveRelief = saveRelief;
        }
        return ModelReliefViewSettings;
    }());
    /**
     * ModelReliefView UI Controls.
     */
    var ModelReliefViewControls = (function () {
        /** Default constructor
         * @class ModelReliefViewerControls
         * @constructor
         */
        function ModelReliefViewControls(modelReliefView) {
         ...
         */
        ModelReliefViewControls.prototype.generateRelief = function () {
            // pixels
            var width = 512;
            var height = width / this._modelReliefView.modelViewer.aspectRatio;
            var factory = new DepthBufferFactory_2.DepthBufferFactory({ width: width, height: height, model: this._modelReliefView.modelViewer.model, camera: this._modelReliefView.modelViewer.camera, addCanvasToDOM: false });
         ...
         */
        ModelReliefViewControls.prototype.saveRelief = function () {
            var exportTag = Services_8.Services.timer.mark('Export OBJ');
            var exporter = new OBJExporter_1.OBJExporter();
            var result = exporter.parse(this._modelReliefView.meshViewer.model);
         ...
         * Initialize the view settings that are controllable by the user
         */
        ModelReliefViewControls.prototype.initializeControls = function () {
            var scope = this;
            ...
            var menuDiv = document.getElementById(this._modelReliefView.containerId);
            menuDiv.appendChild(gui.domElement);
            // ---------------------------------------------------------------------------------------------------------------------------------------------//
            //                                                                   ModelRelief                                                                //      
            // ---------------------------------------------------------------------------------------------------------------------------------------------//
            var modelReliefViewOptions = gui.addFolder('ModelRelief Options');
            // Generate Relief
            var controlGenerateRelief = modelReliefViewOptions.add(this._modelReliefViewSettings, 'generateRelief').name('Generate Relief');
            // Save Relief
            var controlSaveRelief = modelReliefViewOptions.add(this._modelReliefViewSettings, 'saveRelief').name('Save Relief');
            modelReliefViewOptions.open();
        };
        return ModelReliefViewControls;
    }());
    exports.ModelReliefViewControls = ModelReliefViewControls;
});
define("Views/ModelReliefView", ["require", "exports", "ModelLoaders/Loader", "Views/MeshViewer", "ModelRelief", "Controllers/ModelReliefController", "Views/ModelReliefViewControls", "Views/ModelViewer", "System/Services"], function (require, exports, Loader_1, MeshViewer_1, ModelRelief_1, ModelReliefController_1, ModelReliefViewControls_1, ModelViewer_1, Services_9) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
    ...
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ModelReliefView = (function () {
        /** Default constructor
         * @class ModelRelief
         * @constructor
         */
        function ModelReliefView(containerId) {
            this._containerId = containerId;
            this.initialize();
        }
        Object.defineProperty(ModelReliefView.prototype, "containerId", {
            //#region Properties
            /**
        ...
        Object.defineProperty(ModelReliefView.prototype, "modelViewer", {
            /**
        ...
        Object.defineProperty(ModelReliefView.prototype, "meshViewer", {
            /**
             * Gets the MeshViewer.
             */
            get: function () {
        ...
        Object.defineProperty(ModelReliefView.prototype, "loader", {
            /**
             * Gets the Loader.
             */
            get: function () {
         ...
         * Initialziation.
         */
        ModelReliefView.prototype.initialize = function () {
            Services_9.Services.consoleLogger.addInfoMessage('ModelRelief started');
            // Mesh Preview
            this._meshViewer = new MeshViewer_1.MeshViewer('MeshViewer', ModelRelief_1.ContainerIds.MeshCanvas);
            // Model Viewer    
            this._modelViewer = new ModelViewer_1.ModelViewer('ModelViewer', ModelRelief_1.ContainerIds.ModelCanvas);
            // Loader
            ...
            // View UI Controls
            this._modelReliefViewControls = new ModelReliefViewControls_1.ModelReliefViewControls(this);
        };
        return ModelReliefView;
    }());
    exports.ModelReliefView = ModelReliefView;
});
define("ModelRelief", ["require", "exports", "Views/ModelReliefView"], function (require, exports, ModelReliefView_1) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
    ...
    var modelReliefView = new ModelReliefView_1.ModelReliefView(ContainerIds.ComposerView);
});
...
define("Workbench/CameraTest", ["require", "exports", "three", "dat-gui", "Views/Graphics", "System/Services", "Views/Viewer"], function (require, exports, THREE, dat, Graphics_8, Services_10, Viewer_3) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
...
//# sourceMappingURL=data:application/json;charset=utf8;base64,
