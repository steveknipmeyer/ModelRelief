...
define("Viewer/CameraControls", ["require", "exports", "dat-gui", "Viewer/Camera"], function (require, exports, dat, Camera_2) {
    ...
    var CameraControls = (function () {
         ...
         * @param camera
         */
        CameraControls.prototype.synchronizeCameraSettings = function (camera) {
...
define("Viewer/ModelViewerControls", ["require", "exports", "dat-gui", "Viewer/Camera"], function (require, exports, dat, Camera_4) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
    ...
    var ModelViewerSettings = (function () {
        function ModelViewerSettings(camera, generateRelief) {
            ...
            this.standardView = Camera_4.StandardView.Front;
            this.nearClippingPlane = camera.near;
            this.farClippingPlane = camera.far;
            this.fieldOfView = camera.fov;
        }
    ...
    var ModelViewerControls = (function () {
        ...
        ModelViewerControls.prototype.initializeControls = function () {
            ...
            var viewOptions = {
                ...
                Iso: Camera_4.StandardView.Isometric,
                Left: Camera_4.StandardView.Left,
                Right: Camera_4.StandardView.Right,
                Bottom: Camera_4.StandardView.Bottom
            };
            var controlStandardViews = cameraOptions.add(this._modelViewerSettings, 'standardView', viewOptions).name('Standard View');
            controlStandardViews.onChange(function (view) {
...
define("ModelRelief", ["require", "exports", "Viewer/Camera", "System/EventManager", "ModelLoaders/Loader", "Viewer/MeshViewer", "Viewer/ModelViewer", "System/Services"], function (require, exports, Camera_5, EventManager_3, Loader_1, MeshViewer_1, ModelViewer_1, Services_7) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
    ...
    var ModelRelief = (function () {
        ...
        ModelRelief.prototype.onNewModel = function (event, model) {
            ...
            this._meshViewer.setCameraToStandardView(Camera_5.StandardView.Front);
        };
        //#endregion
        /**
