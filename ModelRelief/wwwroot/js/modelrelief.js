...
define("Controllers/ComposerController", ["require", "exports", "Viewer/Camera", "System/EventManager"], function (require, exports, Camera_5, EventManager_3) {
    ...
    var ComposerController = (function () {
        ...
        ComposerController.prototype.initialize = function () {
            this._composerView._modelViewer.eventManager.addEventListener(EventManager_3.EventType.NewModel, this.onNewModel.bind(this));
        };
        //#endregion
        //#region Event Handlers
        /**
        ...
        ComposerController.prototype.onNewModel = function (event, model) {
            this._composerView._modelViewer.setCameraToStandardView(Camera_5.StandardView.Front);
            this._composerView._meshViewer.setCameraToStandardView(Camera_5.StandardView.Top);
        };
...
define("Views/ComposerViewControls", ["require", "exports", "dat-gui", "DepthBuffer/DepthBufferFactory", "ModelExporters/OBJExporter", "System/Services"], function (require, exports, dat, DepthBufferFactory_2, OBJExporter_1, Services_8) {
    ...
    var ComposerViewControls = (function () {
        ...
        ComposerViewControls.prototype.generateRelief = function () {
            // pixels
            var width = 512;
            var height = width / this._composerView.modelViewer.aspectRatio;
            var factory = new DepthBufferFactory_2.DepthBufferFactory({ width: width, height: height, model: this._composerView.modelViewer.model, camera: this._composerView.modelViewer.camera, addCanvasToDOM: false });
        ...
        ComposerViewControls.prototype.saveRelief = function () {
            ...
            var result = exporter.parse(this._composerView.meshViewer.model);
        ...
        ComposerViewControls.prototype.initializeControls = function () {
            ...
            // Generate Relief
            var controlGenerateRelief = modelReliefViewOptions.add(this._composerViewSettings, 'generateRelief').name('Generate Relief');
            // Save Relief
            var controlSaveRelief = modelReliefViewOptions.add(this._composerViewSettings, 'saveRelief').name('Save Relief');
...
define("Views/ComposerView", ["require", "exports", "Controllers/ComposerController", "Views/ComposerViewControls", "ModelLoaders/Loader", "Viewer/MeshViewer", "ModelRelief", "Viewer/ModelViewer", "System/Services"], function (require, exports, ComposerController_1, ComposerViewControls_1, Loader_1, MeshViewer_1, ModelRelief_1, ModelViewer_1, Services_9) {
    // ------------------------------------------------------------------------// 
    // ModelRelief                                                             //
    //                                                                         //                                                                          
    // Copyright (c) <2017> Steve Knipmeyer                                    //
    ...
    var ComposerView = (function () {
        ...
        Object.defineProperty(ComposerView.prototype, "modelViewer", {
            /**
        ...
        Object.defineProperty(ComposerView.prototype, "meshViewer", {
            /**
             * Gets the MeshViewer.
             */
            get: function () {
